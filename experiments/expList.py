...
#	2	#Exceutes 2nd experiment: Comparing the internal and external version with 300 taxa and 64GB RAM available
	...
	#5	#Executes 5th experiment: Comparing the runtime of 2 different parallized versions
#	6	#Executes 6th experiment: Creates a profile of the time spent. Activation of coed lines in QuartetCounterLookup needed	
]
